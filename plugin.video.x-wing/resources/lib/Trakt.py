...
if len(TCI) == 64 and len(TCS) == 64:
	...
	CLIENT_ID     = 'b84b41aab8d4a0e18f1205c70cd5b8db8aad887e45bd9e981666f1342ec75001'
	CLIENT_SECRET = '9a16ab35e55bcfb0f09fdb5b10e96493296242e5f358d3825357ef4d51bae69c'
...
def clear_trakt():
	title = '[B][COLOR lightseagreen]M[/COLOR]x-win[COLOR lightseagreen]G[/COLOR] D[COLOR lightseagreen]S[/COLOR][/B]: Clear Trakt account settings'
