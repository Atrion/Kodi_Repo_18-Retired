...
def _fabtabular():
    ...
    data = os.path.join(__location__, 'iso-639-3.tab') #resource_filename(__package__, 'iso-639-3.tab')
    inverted = os.path.join(__location__, 'iso-639-3_Name_Index.tab') #resource_filename(__package__, 'iso-639-3_Name_Index.tab')
    macro = os.path.join(__location__, 'iso-639-3-macrolanguages.tab') #resource_filename(__package__, 'iso-639-3-macrolanguages.tab')
    part5 = os.path.join(__location__, 'iso639-5.tsv') #resource_filename(__package__, 'iso639-5.tsv')
    part2 = os.path.join(__location__, 'iso639-2.tsv') #resource_filename(__package__, 'iso639-2.tsv')
    part1 = os.path.join(__location__, 'iso639-1.tsv') #resource_filename(__package__, 'iso639-1.tsv')

    # if sys.version_info[0] == 2:
    #     from urllib2 import urlopen
    #     from contextlib import closing
    #     data_fo = closing(urlopen('http://www-01.sil.org/iso639-3/iso-639-3.tab'))
    #     inverted_fo = closing(urlopen('http://www-01.sil.org/i'iso639-2.tsv'so639-3/iso-639-3_Name_Index.tab'))
    # else:
...
class Iso639(object):
    ...
    def retired(self):
        ...
        def gen():
            ...
            with open(os.path.join(__location__, 'iso-639-3_Retirements.tab')) as rf:
