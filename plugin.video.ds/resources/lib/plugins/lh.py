...
"""
    ...
    Returns the Laurel and Hardy Movie list-

    <dir>
    <title>Laurel And Hardy</title>
    <lh>movies</lh>
    </dir>
...
class lh(Plugin):
    ...
    def process_item(self, item_xml):
        if "<lh>" in item_xml:
            ...
            elif "genre" in item.get("lh_movie", ""):    
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_lh_genre_movies",
                    'url': item.get("lh_movie", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
                    'episode': "0",
...
@route(mode='open_lh_genre_movies',args=["url"])
