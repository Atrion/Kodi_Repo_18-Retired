...
from resources.lib.externals.hachoir.hachoir_core.compatibility import reversed
from resources.lib.externals.hachoir.hachoir_core.stream import InputFieldStream
from resources.lib.externals.hachoir.hachoir_core.error import HachoirError, HACHOIR_ERRORS
