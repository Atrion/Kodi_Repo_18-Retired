from resources.lib.externals.hachoir.hachoir_core.i18n import getTerminalCharset, guessBytesCharset, _
from resources.lib.externals.hachoir.hachoir_core.stream import InputIOStream, InputSubStream, InputStreamError
