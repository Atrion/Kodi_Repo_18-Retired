...
from resources.lib.externals.hachoir.hachoir_core.tools import (
    humanDuration, humanBitRate,
    humanFrequency, humanBitSize, humanFilesize,
    humanDatetime)
from resources.lib.externals.hachoir.hachoir_core.language import Language
from resources.lib.externals.hachoir.hachoir_metadata.filter import Filter, NumberFilter, DATETIME_FILTER
from datetime import date, datetime, timedelta
from resources.lib.externals.hachoir.hachoir_metadata.formatter import (
    humanAudioChannel, humanFrameRate, humanComprRate, humanAltitude,
    humanPixelSize, humanDPI)
from resources.lib.externals.hachoir.hachoir_metadata.setter import (
    setDatetime, setTrackNumber, setTrackTotal, setLanguage)
from resources.lib.externals.hachoir.hachoir_metadata.metadata_item import Data
