from resources.lib.externals.hachoir.hachoir_metadata.metadata import RootMetadata, registerExtractor
from resources.lib.externals.hachoir.hachoir_metadata.safe import fault_tolerant
from resources.lib.externals.hachoir.hachoir_parser.container import SwfFile
from resources.lib.externals.hachoir.hachoir_parser.misc import TorrentFile, TrueTypeFontFile, OLE2_File, PcfFile
from resources.lib.externals.hachoir.hachoir_core.field import isString
from resources.lib.externals.hachoir.hachoir_core.error import warning
from resources.lib.externals.hachoir.hachoir_parser import guessParser
from resources.lib.externals.hachoir.hachoir_metadata.setter import normalizeString
