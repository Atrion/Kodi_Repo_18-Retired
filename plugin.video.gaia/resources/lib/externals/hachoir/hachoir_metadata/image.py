...
from resources.lib.externals.hachoir.hachoir_parser.image import (
    BmpFile, IcoFile, PcxFile, GifFile, PngFile, TiffFile,
    XcfFile, TargaFile, WMF_File, PsdFile)
from resources.lib.externals.hachoir.hachoir_parser.image.png import getBitsPerPixel as pngBitsPerPixel
from resources.lib.externals.hachoir.hachoir_parser.image.xcf import XcfProperty
