...
from resources.lib.externals.hachoir.hachoir_parser.audio import AuFile, MpegAudioFile, RealAudioFile, AiffFile, FlacParser
from resources.lib.externals.hachoir.hachoir_parser.container import OggFile, RealMediaFile
from resources.lib.externals.hachoir.hachoir_core.i18n import _
from resources.lib.externals.hachoir.hachoir_core.tools import makePrintable, timedelta2seconds, humanBitRate
from datetime import timedelta
from resources.lib.externals.hachoir.hachoir_metadata.metadata_item import QUALITY_FAST, QUALITY_NORMAL, QUALITY_BEST
from resources.lib.externals.hachoir.hachoir_metadata.safe import fault_tolerant, getValue
