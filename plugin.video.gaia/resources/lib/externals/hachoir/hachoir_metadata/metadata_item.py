from resources.lib.externals.hachoir.hachoir_core.tools import makeUnicode, normalizeNewline
from resources.lib.externals.hachoir.hachoir_core.error import HACHOIR_ERRORS
from resources.lib.externals.hachoir.hachoir_metadata import config
