...
from resources.lib.externals.hachoir.hachoir_core.text_handler import (
    displayHandler, filesizeHandler)
from resources.lib.externals.hachoir.hachoir_core.tools import humanBitRate
from itertools import izip
from resources.lib.externals.hachoir.hachoir_parser.video.fourcc import audio_codec_name, video_fourcc_name
from resources.lib.externals.hachoir.hachoir_parser.common.win32 import BitmapInfoHeader, GUID
