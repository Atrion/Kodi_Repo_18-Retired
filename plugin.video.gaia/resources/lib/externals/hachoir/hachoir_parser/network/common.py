from resources.lib.externals.hachoir.hachoir_core.field import FieldSet, Field, Bits
from resources.lib.externals.hachoir.hachoir_core.bits import str2hex
from resources.lib.externals.hachoir.hachoir_parser.network.ouid import REGISTERED_OUID
