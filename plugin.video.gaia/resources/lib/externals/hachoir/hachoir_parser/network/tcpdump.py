...
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet, ParserError,
    ...
    Bit, Bits, NullBits)
from resources.lib.externals.hachoir.hachoir_core.endian import NETWORK_ENDIAN, LITTLE_ENDIAN
...
from resources.lib.externals.hachoir.hachoir_parser.network.common import MAC48_Address, IPv4_Address, IPv6_Address
