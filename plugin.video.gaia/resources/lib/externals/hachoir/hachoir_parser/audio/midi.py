...
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet, Bits, ParserError,
...
from resources.lib.externals.hachoir.hachoir_core.tools import createDict, humanDurationNanosec
