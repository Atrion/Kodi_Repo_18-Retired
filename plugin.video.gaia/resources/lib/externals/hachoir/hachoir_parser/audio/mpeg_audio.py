...
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet,
    ...
    RawBytes)
from resources.lib.externals.hachoir.hachoir_parser.audio.id3 import ID3v1, ID3v2
from resources.lib.externals.hachoir.hachoir_core.endian import BIG_ENDIAN
from resources.lib.externals.hachoir.hachoir_core.tools import humanFrequency, humanBitSize
from resources.lib.externals.hachoir.hachoir_core.bits import long2raw
from resources.lib.externals.hachoir.hachoir_core.error import HACHOIR_ERRORS
from resources.lib.externals.hachoir.hachoir_core.stream import InputStreamError
