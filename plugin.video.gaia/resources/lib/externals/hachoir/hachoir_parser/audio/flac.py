...
from resources.lib.externals.hachoir.hachoir_core.field import FieldSet, String, Bit, Bits, UInt16, UInt24, RawBytes, Enum, NullBytes
from resources.lib.externals.hachoir.hachoir_core.stream import BIG_ENDIAN, LITTLE_ENDIAN
from resources.lib.externals.hachoir.hachoir_core.tools import createDict
from resources.lib.externals.hachoir.hachoir_parser.container.ogg import parseVorbisComment
