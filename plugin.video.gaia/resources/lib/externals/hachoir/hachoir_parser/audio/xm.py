...
from resources.lib.externals.hachoir.hachoir_core.field import (StaticFieldSet, FieldSet,
    Bit, RawBits, Bits,
...
from resources.lib.externals.hachoir.hachoir_parser.audio.modplug import ParseModplugMetadata
from resources.lib.externals.hachoir.hachoir_parser.common.tracker import NOTE_NAME
