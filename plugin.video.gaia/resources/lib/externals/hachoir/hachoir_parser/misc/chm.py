...
from resources.lib.externals.hachoir.hachoir_core.field import (Field, FieldSet, ParserError,
    Int32, UInt32, UInt64,
...
from resources.lib.externals.hachoir.hachoir_parser.common.win32_lang_id import LANGUAGE_ID
