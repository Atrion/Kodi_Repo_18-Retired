...
from resources.lib.externals.hachoir.hachoir_core.field import (RootSeekableFieldSet, FieldSet, Enum,
...
from resources.lib.externals.hachoir.hachoir_core.text_handler import displayHandler
