...
from resources.lib.externals.hachoir.hachoir_core.text_handler import textHandler, hexadecimal, filesizeHandler
...
from resources.lib.externals.hachoir.hachoir_parser.common.win32 import GUID, PascalStringWin32, CODEPAGE_CHARSET
from resources.lib.externals.hachoir.hachoir_parser.image.bmp import BmpHeader, parseImageData
