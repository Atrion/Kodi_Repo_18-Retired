...
from resources.lib.externals.hachoir.hachoir_core.field import (
...
from resources.lib.externals.hachoir.hachoir_core.text_handler import filesizeHandler
from resources.lib.externals.hachoir.hachoir_core.endian import LITTLE_ENDIAN
from resources.lib.externals.hachoir.hachoir_parser.common.win32 import GUID
from resources.lib.externals.hachoir.hachoir_parser.misc.msoffice import CustomFragment, OfficeRootEntry, PROPERTY_NAME
from resources.lib.externals.hachoir.hachoir_parser.misc.word_doc import WordDocumentParser
from resources.lib.externals.hachoir.hachoir_parser.misc.msoffice_summary import SummaryParser
