...
from resources.lib.externals.hachoir.hachoir_core.field import FieldSet, RootSeekableFieldSet, RawBytes
from resources.lib.externals.hachoir.hachoir_core.endian import LITTLE_ENDIAN
from resources.lib.externals.hachoir.hachoir_core.stream import StringInputStream
from resources.lib.externals.hachoir.hachoir_parser.misc.msoffice_summary import SummaryFieldSet, CompObj
from resources.lib.externals.hachoir.hachoir_parser.misc.word_doc import WordDocumentFieldSet
