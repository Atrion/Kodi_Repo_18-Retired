...
import os
from resources.lib.externals.hachoir.hachoir_core.error import warning, info, HACHOIR_ERRORS
from resources.lib.externals.hachoir.hachoir_parser import ValidateError, HachoirParserList
from resources.lib.externals.hachoir.hachoir_core.stream import FileInputStream
