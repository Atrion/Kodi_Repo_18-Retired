...
from resources.lib.externals.hachoir.hachoir_core.field import StaticFieldSet
from resources.lib.externals.hachoir.hachoir_core.field import Bit, NullBits
