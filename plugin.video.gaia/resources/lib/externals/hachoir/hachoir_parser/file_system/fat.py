from resources.lib.externals.hachoir.hachoir_core.compatibility import sorted
from resources.lib.externals.hachoir.hachoir_parser import Parser
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet, StaticFieldSet,
    RawBytes, PaddingBytes, createPaddingField, Link, Fragment,
    Bit, Bits, UInt8, UInt16, UInt32,
    String, Bytes, NullBytes)
from resources.lib.externals.hachoir.hachoir_core.field.integer import GenericInteger
...
from resources.lib.externals.hachoir.hachoir_core.error import error
from resources.lib.externals.hachoir.hachoir_core.tools import humanFilesize, makePrintable
import datetime
import re
