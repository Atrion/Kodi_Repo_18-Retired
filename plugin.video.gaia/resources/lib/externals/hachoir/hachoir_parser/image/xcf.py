...
from resources.lib.externals.hachoir.hachoir_core.field import (StaticFieldSet, FieldSet, ParserError,
    UInt8, UInt32, Enum, Float32, String, PascalString32, RawBytes)
from resources.lib.externals.hachoir.hachoir_parser.image.common import RGBA
