...
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet, SeekableFieldSet, ParserError, RootSeekableFieldSet,
    UInt16, UInt32, Bytes, String)
from resources.lib.externals.hachoir.hachoir_core.endian import LITTLE_ENDIAN, BIG_ENDIAN
from resources.lib.externals.hachoir.hachoir_parser.image.exif import BasicIFDEntry
