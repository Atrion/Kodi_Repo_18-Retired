...
from resources.lib.externals.hachoir.hachoir_core.error import HachoirError
...
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet, ParserError,
    ...
    String, RawBytes)
from resources.lib.externals.hachoir.hachoir_parser.image.common import PaletteRGB
...
from resources.lib.externals.hachoir.hachoir_parser.image.exif import Exif
from resources.lib.externals.hachoir.hachoir_parser.image.photoshop_metadata import PhotoshopMetadata
