...
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet, Fragment,
...
from resources.lib.externals.hachoir.hachoir_core.tools import humanFilesize
