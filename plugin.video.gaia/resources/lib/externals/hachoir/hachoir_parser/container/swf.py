...
from resources.lib.externals.hachoir.hachoir_core.endian import LITTLE_ENDIAN, BIG_ENDIAN
from resources.lib.externals.hachoir.hachoir_core.text_handler import textHandler, filesizeHandler
from resources.lib.externals.hachoir.hachoir_core.tools import paddingSize, humanFrequency
from resources.lib.externals.hachoir.hachoir_parser.image.common import RGB
from resources.lib.externals.hachoir.hachoir_parser.image.jpeg import JpegChunk, JpegFile
from resources.lib.externals.hachoir.hachoir_core.stream import StringInputStream, ConcatStream
from resources.lib.externals.hachoir.hachoir_parser.common.deflate import Deflate, has_deflate
from resources.lib.externals.hachoir.hachoir_parser.container.action_script import parseActionScript
import math
