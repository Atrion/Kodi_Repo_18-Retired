...
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet, ParserError,
    ...
    RawBytes)
#from resources.lib.externals.hachoir.hachoir_core.field import Field
from resources.lib.externals.hachoir.hachoir_core.field.float import FloatExponent
