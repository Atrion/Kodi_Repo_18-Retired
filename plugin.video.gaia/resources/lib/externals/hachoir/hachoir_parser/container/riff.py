...
from resources.lib.externals.hachoir.hachoir_core.field import (FieldSet, ParserError,
    ...
    SubFile)
from resources.lib.externals.hachoir.hachoir_core.tools import alignValue, humanDuration
from resources.lib.externals.hachoir.hachoir_core.endian import LITTLE_ENDIAN
from resources.lib.externals.hachoir.hachoir_core.text_handler import filesizeHandler, textHandler
