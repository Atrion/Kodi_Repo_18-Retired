...
class source:
	def __init__(self):
		...
		self.enabled = tools.Settings.getBoolean('accounts.providers.nzbfinder.enabled')
		self.api = tools.Settings.getString('accounts.providers.nzbfinder.api')
				...
				for item in result['item']:
					...
					if 'newznab:attr' in item:
						for attribute in item['newznab:attr']:
							...
							if 'password' in attribute['_name']:
								jsonPassword = int(attribute['_value'])
							if 'usenetdate' in attribute['_name']:
								try:
