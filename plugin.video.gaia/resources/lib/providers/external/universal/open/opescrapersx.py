...
class source:
	...
	def _instancesRename(self, path):
		...
		replacements = [
			['from resources.lib.', 'from openscrapers.'],
			['from openscrapers.modules import cfscrape', 'try: from openscrapers.modules import cfscrape\nexcept: pass'],
			['xbmcaddon.Addon()', 'xbmcaddon.Addon("' + tools.Extensions.IdOpeScrapers + '")'],
