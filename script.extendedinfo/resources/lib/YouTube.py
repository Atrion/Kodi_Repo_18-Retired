...
API_key = 'AIzaSyB-BOZ_o09NLVwq_lMskvvj1olDkFI4JK0'
...
def handle_youtube_videos(results, extended=False):
	...
	url = 'https://www.googleapis.com/youtube/v3/videos?id=%s&part=contentDetails%%2Cstatistics&key=AIzaSyB-BOZ_o09NLVwq_lMskvvj1olDkFI4JK0' % (','.join(video_ids))
